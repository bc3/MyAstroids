...
namespace MyAstroids.Engine
{
        ...
        {
            public SmokePlumeParticleSystem(GameObjectProperties go, int howManyEffects)
                : base(go, howManyEffects)
            {
            }
            ...
            //    float radians = World.RandomBetween(
            ...
            protected override void InitializeParticle(Particle p, Vector2 where)
            {
                ...
                //p.Acceleration.X += World.RandomBetween(10, 50);
            }
        }
    }
