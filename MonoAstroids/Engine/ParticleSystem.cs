...
namespace MyAstroids.Engine
{
    ...
    /// </summary>
    public abstract class ParticleSystem : GameObject
    {
        ...
        public ParticleSystem(GameObjectProperties go, int howManyEffects)
            : base(go)
        {            
            this.w = go.world;
        ...
        protected override void LoadContent()
        {
            ...
            // load the texture....
            texture = w.content.Load<Texture2D>(textureFilename);
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles = 
                (int)World.RandomBetween(minNumParticles, maxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float velocity = 
                World.RandomBetween(minInitialSpeed, maxInitialSpeed);
            float acceleration =
                World.RandomBetween(minAcceleration, maxAcceleration);
            float lifetime =
                World.RandomBetween(minLifetime, maxLifetime);
            float scale =
                World.RandomBetween(minScale, maxScale);
            float rotationSpeed =
                World.RandomBetween(minRotationSpeed, maxRotationSpeed);
        ...
        {
            float angle = World.RandomBetween(0, MathHelper.TwoPi);
